...
st.image("https://images.unsplash.com/photo-1488477181946-6428a9a7e6cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80", 
...
# Thêm ảnh nền màu hồng từ Unsplash
background_image_url = "https://images.unsplash.com/photo-1553356084-58ef4a31c595?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"
st.markdown(f"""
<style>
    .stApp {{
